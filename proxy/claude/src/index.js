...
const APP_VERSION = "49-2026-08-19";
...
function buildLeadSearchSystemPrompt(
  ...
  let prompt =
    ...
    "- Контакты (телефон и/или email) критически важны — без них с компанией нельзя связаться, и такой лид почти бесполезен. Если после первых результатов поиска у компании нет ни телефона, ни email, ОБЯЗАТЕЛЬНО сделай 1-2 дополнительных web_search запроса именно за контактами: загляни на сайт компании, страницу «Контакты», поищи запрос вида «<название компании> телефон email контакты». Не вызывай return_lead_candidates, пока не попытался найти контакты для каждой компании из списка.\n" +
